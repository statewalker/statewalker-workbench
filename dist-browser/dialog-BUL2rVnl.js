...
import { a as z, c as o } from "./utils-gWiv5-6R.js";
import { Slot as D, Dialog as r } from "radix-ui";
import { XIcon as w } from "lucide-react";
const b = (t) => typeof t == "boolean" ? `${t}` : t === 0 ? "0" : t, p = z, _ = (t, e) => (a) => {
  var i;
  if ((e == null ? void 0 : e.variants) == null) return p(t, a == null ? void 0 : a.class, a == null ? void 0 : a.className);
  const { variants: u, defaultVariants: d } = e, h = Object.keys(u).map((s) => {
    const l = a == null ? void 0 : a[s], g = d == null ? void 0 : d[s];
    if (l === null) return null;
    const c = b(l) || b(g);
    return u[s][c];
  }), m = a && Object.entries(a).reduce((s, l) => {
    let [g, c] = l;
    return c === void 0 || (s[g] = c), s;
  }, {}), y = e == null || (i = e.compoundVariants) === null || i === void 0 ? void 0 : i.reduce((s, l) => {
    let { class: g, className: c, ...N } = l;
  ...
  ({ className: t = "", variant: e = "default", ...a }, i) => /* @__PURE__ */ n(
    "span",
    {
      ref: i,
