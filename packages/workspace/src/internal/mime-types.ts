...
export const mimeTypes: MimeTypeEntry[] = [
  ...
  { extensions: ["js"], mime: "text/javascript", description: "JavaScript" },
  ...
  { extensions: ["xml"], mime: "application/xml", description: "XML" },
  ...
  { extensions: ["3g2"], mime: "video/3gpp2", description: "3GPP2 audio/video container" },
  {
    extensions: ["7z"],
  ...
  },
  {
    extensions: ["jsx"],
    mime: "text/jsx",
    description: "JavaScript Syntax Extension / JavaScript XML format",
  },
  { extensions: ["ts"], mime: "text/ts", description: "TypeScript format" },
  {
    extensions: ["tsx"],
    mime: "text/tsx",
    description: "TypeScript Syntax Extension / TypeScript XML format",
  },
];

export const mimeTypesDescriptions: Record<string, string> = mimeTypes.reduce(
  (index: Record<string, string>, t) => {
...
export const extensionToMimeType: Record<string, string> = mimeTypes.reduce(
  (index: Record<string, string>, t) => {
...
export const mimeTypeToExtensions: Record<string, string[]> = mimeTypes.reduce(
  (index: Record<string, string[]>, t) => {
