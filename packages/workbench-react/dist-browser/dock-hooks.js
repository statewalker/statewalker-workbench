...
import { a as J, u as K, e as M, c as N, b as O, f as q } from "./tree-DPPIyetn.js";
...
function $() {
  const T = H(U);
  if (!T) throw new Error("useDockLayout must be used within a DockProvider");
  return T;
}
function tt({ children: T, initialLayout: f }) {
  ...
  const E = e((n, r) => {
    ...
    v = e((n, r, o, c) => {
      u((l) => {
        if (r === o && c === "center") return l;
        if (r === o && c !== "center") {
          const w = O(l, r);
          if (w && w.tabs.length <= 1) return l;
        }
        const { node: h, tab: k } = q(l, r, n);
        return !k || !h ? l : J(h, o, k, c);
      });
    }, []),
    z = e(
      (n) => {
        D && (v(D.tabId, D.sourcePanelId, D.targetPanelId, n), m(null));
      },
      [D, v],
    ),
    b = e(() => {
  ...
  const {
    ...
    h = e(
      (t) => {
        ...
        const a = N(t.clientX, t.clientY, x);
        S(a),
          p(a, { x: t.clientX, y: t.clientY }),
    ...
    F = e(
      (t) => {
        t.preventDefault(),
          t.stopPropagation(),
          S("center"),
          p("center", { x: t.clientX, y: t.clientY }),
          s.current && v(s.current.getBoundingClientRect()),
          b(!1);
      },
      [p],
