...
import {
  ...
  B as u,
  k as w,
} from "./dialog-BUL2rVnl.js";

function W({ value: e }) {
  const r = f();
  if (typeof e === "string") return /* @__PURE__ */ t("span", { children: e });
  const n = r.resolve(e);
  return n
    ? /* @__PURE__ */ t(n, { model: e })
    : /* @__PURE__ */ t("span", {
        className: "text-sm text-muted-foreground",
        children: "No renderer",
      });
}
function c({ model: e }) {
  const n = f().resolve(e);
  ...
  return (
    ...
    /* @__PURE__ */ a("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ t("pre", {
          className: "text-sm bg-muted rounded-md p-3 overflow-auto max-h-64 whitespace-pre-wrap",
...
function Y({ model: e }) {
  o(e.onUpdate);
  const r = e.sortedRows,
    n = e.selectionMode !== "none";
          ...
          /* @__PURE__ */ t("thead", {
            ...
            children: /* @__PURE__ */ a("tr", {
              children: [
                n &&
                  /* @__PURE__ */ t("th", {
                    className: "h-10 px-2 text-left align-middle w-10",
                  ...
                  return /* @__PURE__ */ t(
                    "th",
                    {
                      ...
                      children: /* @__PURE__ */ a("span", {
                        ...
                        children: [
                          i.label,
                          ((s = e.sortDescriptor) == null ? void 0 : s.column) === i.key &&
                            /* @__PURE__ */ t("span", {
                              className: "text-xs",
                              children:
                                ((d = e.sortDescriptor) == null ? void 0 : d.direction) ===
                                "ascending"
                                  ? "▲"
                                  : "▼",
                            }),
                    ...
                    e.columns.map((l) =>
                      /* @__PURE__ */ t(
                        "td",
                        {
                          ...
                          children: l.render ? l.render(d[l.key], i) : String(d[l.key] ?? ""),
                        },
                        l.key,
                      ),
                    ),
...
function g({ node: e, model: r, depth: n }) {
  var l;
  const i = e.children && e.children.length > 0,
    s = r.isExpanded(e.key),
    d = r.selectedKeys.values().next().value === e.key;
  return /* @__PURE__ */ a("div", {
    children: [
      /* @__PURE__ */ a("button", {
        type: "button",
        ...
        children: [
          i
            ? s
              ? /* @__PURE__ */ t(x, { className: "h-4 w-4 shrink-0 text-muted-foreground" })
              : /* @__PURE__ */ t(b, { className: "h-4 w-4 shrink-0 text-muted-foreground" })
            : /* @__PURE__ */ t("span", { className: "w-4 shrink-0" }),
          i
            ? s
              ? /* @__PURE__ */ t(m, { className: "h-4 w-4 shrink-0 text-muted-foreground" })
              : /* @__PURE__ */ t(y, { className: "h-4 w-4 shrink-0 text-muted-foreground" })
            : /* @__PURE__ */ t(v, { className: "h-4 w-4 shrink-0 text-muted-foreground" }),
...
function q({ model: e }) {
  return (
    ...
    /* @__PURE__ */ t("div", {
      className: "p-2",
      children: e.roots.map((r) => /* @__PURE__ */ t(g, { node: r, model: e, depth: 0 }, r.key)),
    })
  );
}
function Q({ model: e }) {
  return (
    ...
    /* @__PURE__ */ a("div", {
      ...
      children: [
        e.icon &&
          /* @__PURE__ */ t("span", { className: "mb-3 text-4xl opacity-50", children: e.icon }),
        /* @__PURE__ */ t("h3", { className: "text-lg font-medium", children: e.heading }),
        e.description &&
          /* @__PURE__ */ t("p", { className: "mt-1 text-sm", children: e.description }),
        e.action &&
          /* @__PURE__ */ t("div", {
            className: "mt-4",
            children: /* @__PURE__ */ t(p, { action: e.action }),
          }),
      ],
    })
  );
    ...
    children: [
      e.header &&
        /* @__PURE__ */ t(k, {
          children: /* @__PURE__ */ t(w, {
            children:
              typeof e.header === "string" ? e.header : /* @__PURE__ */ t(c, { model: e.header }),
          }),
        }),
      /* @__PURE__ */ t(C, {
      ...
      r &&
        /* @__PURE__ */ a(R, {
          children: [
            e.footer &&
              (typeof e.footer === "string" ? e.footer : /* @__PURE__ */ t(c, { model: e.footer })),
            e.actions.length > 0 &&
              /* @__PURE__ */ t("div", {
                className: "flex gap-2 ml-auto",
                children: e.actions.map((n) => /* @__PURE__ */ t(p, { action: n }, n.actionKey)),
              }),
          ],
        }),
    ],
...
function Z({ model: e }) {
  ...
  return /* @__PURE__ */ t("div", {
    className: n,
    style: { gap: e.gap },
    children: e.children.map((i) => /* @__PURE__ */ t(c, { model: i }, i.key)),
  });
}
function _({ model: e }) {
  var r;
...
function ee({ model: e }) {
  return (
    o(e.onUpdate),
    /* @__PURE__ */ t("div", {
      className: "w-full divide-y divide-border border rounded-md",
          ...
          "div",
          {
            children: [
              ...
              n &&
                /* @__PURE__ */ t("div", {
                  className: "px-4 pb-3",
                  children: /* @__PURE__ */ t(c, { model: r.content }),
                }),
            ],
          },
          r.key,
  ...
  return (
    ...
    /* @__PURE__ */ a("div", {
      ...
      children: [
        /* @__PURE__ */ a("span", {
          className: "text-sm text-muted-foreground",
          children: ["Page ", e.page, " of ", e.totalPages],
        }),
        /* @__PURE__ */ a("div", {
  ...
  return /* @__PURE__ */ a("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ t("div", {
        className: "pt-4",
        role: "tabpanel",
        children: r && /* @__PURE__ */ t(c, { model: r.content }),
      }),
    ],
  });
}
          ...
          children: e.items.map((s) =>
            /* @__PURE__ */ t(
              "button",
              {
                type: "button",
                className:
                  "w-full rounded-sm px-3 py-1.5 text-sm text-left hover:bg-muted cursor-pointer",
                onClick: () => {
                  s.submit(), n(null);
                },
    ...
    /* @__PURE__ */ t(D, {
      ...
      children: /* @__PURE__ */ a(U, {
        ...
        children: [
          ...
          /* @__PURE__ */ t("div", {
            children: e.children.map((r) => /* @__PURE__ */ t(c, { model: r }, r.key)),
          }),
          e.footer &&
            /* @__PURE__ */ t(P, {
              children:
            ...
            /* @__PURE__ */ a("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ t("div", {
                  ...
                  children: e.content && /* @__PURE__ */ t(c, { model: e.content }),
                }),
                e.actions.length > 0 &&
                  /* @__PURE__ */ t("div", {
                    className: "flex justify-end gap-2 border-t border-border p-4",
                    children: e.actions.map((r) =>
                      /* @__PURE__ */ t(p, { action: r }, r.actionKey),
                    ),
                  }),
              ],
            }),
