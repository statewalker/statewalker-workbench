...
const B = "-",
  ...
  D = (e, r) => {
    ...
    const n = e.join(B);
    return (a = r.validators.find(({ validator: s }) => s(n))) == null ? void 0 : a.classGroupId;
  },
  K = /^\[(.+)\]$/,
  le = (e) => {
    if (K.test(e)) {
  ...
  ie = (e) => {
    ...
    return (
      ce(Object.entries(e.classGroups), t).forEach(([n, a]) => {
        $(a, o, n, r);
      }),
      o
    );
      ...
      ? e.map(([t, o]) => {
          const l = o.map((n) =>
            typeof n === "string"
              ? r + n
              : typeof n === "object"
                ? Object.fromEntries(Object.entries(n).map(([a, s]) => [r + a, s]))
                : n,
          );
          return [t, l];
        })
...
function me() {
  let e = 0,
    ...
    t,
    o = "";
  for (; e < arguments.length; ) (r = arguments[e++]) && (t = re(r)) && (o && (o += " "), (o += t));
  return o;
}
const re = (e) => {
  ...
  let r,
    t = "";
  for (let o = 0; o < e.length; o++) e[o] && (r = re(e[o])) && (t && (t += " "), (t += r));
  return t;
};
function he(e, ...r) {
  let t,
...
const c = (e) => {
  ...
  te = /^\[(?:([a-z-]+):)?(.+)\]$/i,
  ye = /^\d+\/\d+$/,
  xe = /* @__PURE__ */ new Set(["px", "full", "screen"]),
  we = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/,
  ve =
  ...
  C = (e) => M(e) || xe.has(e) || ye.test(e),
  z = (e) => G(e, "length", je),
  M = (e) => !!e && !Number.isNaN(Number(e)),
  _ = (e) => G(e, "number", M),
  P = (e) => !!e && Number.isInteger(Number(e)),
  Ae = (e) => e.endsWith("%") && M(e.slice(0, -1)),
  i = (e) => te.test(e),
  A = (e) => we.test(e),
  Se = /* @__PURE__ */ new Set(["length", "size", "percentage"]),
  Me = (e) => G(e, Se, oe),
  Ge = (e) => G(e, "position", oe),
  Re = /* @__PURE__ */ new Set(["image", "url"]),
  Ie = (e) => G(e, Re, Ne),
  Pe = (e) => G(e, "", Ee),
  j = () => !0,
  G = (e, r, t) => {
