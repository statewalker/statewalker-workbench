...
function I({ className: t, variant: e, ...o }) {
...
function B({ className: t, ...e }) {
  return /* @__PURE__ */ r(s.Root, {
    "data-slot": "avatar",
    className: a("relative flex size-8 shrink-0 overflow-hidden rounded-full select-none", t),
    ...e,
  });
}
function A({ className: t, ...e }) {
  return /* @__PURE__ */ r(s.Image, {
...
function j({ asChild: t, className: e, ...o }) {
  const n = t ? f.Root : "a";
  return /* @__PURE__ */ r(n, {
...
function L({ children: t, className: e, ...o }) {
  return /* @__PURE__ */ r("li", {
...
function V({ className: t, orientation: e, ...o }) {
  return /* @__PURE__ */ r("div", {
    role: "group",
...
function _({ className: t, asChild: e = !1, ...o }) {
...
function F({ className: t, ...e }) {
  return /* @__PURE__ */ r(p.Root, {
    ...
    ...e,
    children: /* @__PURE__ */ r(p.Indicator, {
...
function H({ ...t }) {
  return /* @__PURE__ */ r(l.CollapsibleTrigger, {
    "data-slot": "collapsible-trigger",
    ...t,
  });
}
function E({ ...t }) {
  return /* @__PURE__ */ r(l.CollapsibleContent, {
...
function J({ className: t, align: e = "inline-start", ...o }) {
  return /* @__PURE__ */ r("div", {
    role: "group",
    ...
    onClick: (d) => {
      ...
      d.target.closest("button") ||
        (c = (u = d.currentTarget.parentElement) == null ? void 0 : u.querySelector("input")) ==
          null ||
        c.focus();
    },
    ...o,
...
function Q({ className: t, value: e, ...o }) {
  return /* @__PURE__ */ r(g.Root, {
    "data-slot": "progress",
    className: a("relative h-2 w-full overflow-hidden rounded-full bg-primary/20", t),
    ...o,
    children: /* @__PURE__ */ r(g.Indicator, {
...
function U({ className: t = "" }) {
  return /* @__PURE__ */ r("span", {
    className:
      `spinner inline-block w-4 h-4 border-2 border-current border-t-transparent rounded-full animate-spin ${t}`.trim(),
  });
}
function W({ delayDuration: t = 0, ...e }) {
...
function tt({ className: t, sideOffset: e = 0, children: o, ...n }) {
  return /* @__PURE__ */ r(i.Portal, {
    children: /* @__PURE__ */ r(i.Content, {
