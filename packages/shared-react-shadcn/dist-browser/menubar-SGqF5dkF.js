import { ChevronRightIcon as c, CheckIcon as u } from "lucide-react";
import { Menubar as n } from "radix-ui";
import { jsx as a, jsxs as d } from "react/jsx-runtime";
import { c as o } from "./utils-gWiv5-6R.js";

function g({ className: e, ...t }) {
  return /* @__PURE__ */ a(n.Root, {
    "data-slot": "menubar",
    className: o("flex h-9 items-center gap-1 rounded-md border bg-background p-1 shadow-xs", e),
    ...t,
  });
}
function x({ ...e }) {
...
function h({ className: e, align: t = "start", alignOffset: r = -4, sideOffset: s = 8, ...i }) {
  return /* @__PURE__ */ a(m, {
...
function M({ className: e, inset: t, variant: r = "default", ...s }) {
...
function z({ className: e, children: t, checked: r, ...s }) {
  return /* @__PURE__ */ d(n.CheckboxItem, {
    ...
    children: [
      /* @__PURE__ */ a("span", {
        ...
        children: /* @__PURE__ */ a(n.ItemIndicator, {
...
function k({ className: e, ...t }) {
  return /* @__PURE__ */ a("span", {
    ...
    className: o("ml-auto text-xs tracking-widest text-muted-foreground", e),
    ...t,
  });
}
function w({ ...e }) {
...
function S({ className: e, inset: t, children: r, ...s }) {
  return /* @__PURE__ */ d(n.SubTrigger, {
    ...
    ...s,
    children: [r, /* @__PURE__ */ a(c, { className: "ml-auto h-4 w-4" })],
  });
}
function y({ className: e, ...t }) {
  return /* @__PURE__ */ a(n.SubContent, {
...
export { g as M, x as a, v as b, h as c, M as d, z as e, N as f, k as g, w as h, y as i, S as j };
