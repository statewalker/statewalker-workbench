...
var f = (t, s, e) =>
  s in t ? b(t, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : (t[s] = e);
...
class r extends u {
  ...
  remove(e) {
    this._items.indexOf(e) >= 0 &&
      ((this._items = this._items.filter((n) => n !== e)), this.notify());
  }
  getAll() {
    return this._items;
  }
...
const [m] = o("model:activePanel", () => new y());
function R(t, s) {
  m(t).setActivePanel(s);
}
class p extends r {}
const [x] = o("aspect:context-menu", () => new p()),
  [B, U] = h(x);
class V extends r {
  getTopmost() {
    const s = this.getAll();
...
const [_] = o("aspect:dialogs", () => new V()),
  [O, S] = h(_);
class P extends u {
  constructor() {
    super(...arguments);
...
class j extends d {
  constructor(e) {
    ...
    (this.label = e.label),
      ...
      (this.area = e.area ?? "center"),
      (this.closable = e.closable ?? !1);
  }
}
const [A] = o("aspect:panel-registry", () => new r()),
  [q, z] = h(A);
class M extends r {}
const [v] = o("aspect:toolbar", () => new M()),
  [I, E] = h(v);
class k extends r {}
const [T] = o("aspect:top-menu", () => new k()),
  [F, G] = h(T);
export {
  y as A,
  p as C,
