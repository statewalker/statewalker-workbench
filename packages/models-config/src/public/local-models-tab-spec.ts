...
/**
 * json-render spec for the Settings dialog's "Local Models" tab
 * body. Same row content as the prior `localModelsDialog` body from
 * the v4 draft, with no surrounding Dialog (the Settings dialog
 * provides that wrapping).
 */
      ...
      localModelRowUse: {
        ...
        on: {
          press: [
            {
              action: "selectModel",
              params: { connectionId: "local", modelId: { $item: "key" } },
            },
          ],
        },
      },
