 ...
 */
export const [runMkdirPrompt, handleMkdirPrompt] = newIntent<
  MkdirPromptPayload,
  { name: string }
 ...
 * `files:delete-file`.
 */
export const [runConfirmDelete, handleConfirmDelete] = newIntent<
 ...
 */
export const [runConfirmCopyMove, handleConfirmCopyMove] = newIntent<
  ConfirmCopyMovePayload,
  void
