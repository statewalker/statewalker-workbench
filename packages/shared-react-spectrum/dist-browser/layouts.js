...
import { newAdapter as re } from "@statewalker/shared-adapters";
import {
  ComponentRegistryContext as ae,
  useComponentRegistry as ie,
  ReactComponentRegistry as le,
} from "@statewalker/shared-react/component-registry";
import {
  findAndRemoveTab as _,
  updatePanelActiveTab as be,
  isSplit as De,
  addTabToPanel as me,
  calculateDropPosition as Se,
  updateSplitSizes as ve,
  findPanel as X,
  isPanel as xe,
  panelsToTree as ye,
} from "@statewalker/shared-react/dock";
import {
  getDialogStackView as ce,
  getTopMenuView as de,
  getActivePanelView as ge,
  getKeyboardView as pe,
  getToolbarView as se,
  listenPanel as ue,
...
import { Separator as Ce, Panel as ke, Group as we } from "react-resizable-panels";
...
function Pe({ children: e, initialLayout: o }) {
  const [i, c] = I(o),
    [g, m] = I(null),
    [p, l] = I(null);
  R(() => c(o), [o]);
  const w = D((f, d) => m({ tabId: f, sourcePanelId: d }), []),
    S = D(() => m(null), []),
    T = D(
      (f, d, a) => {
        const r = g;
    ...
    s = D(
      (f) => {
        p && (b(p.tabId, p.sourcePanelId, p.targetPanelId, f), l(null));
      },
      [p, b],
    ),
    k = D(() => l(null), []),
...
function Ie({
  ...
  const { colorScheme: p } = O(),
    l = p === "dark";
  if (!m) return null;
  const w = 140,
    S = 130;
  let T = g.x - m.left - w / 2,
    b = g.y - m.top - S / 2;
  return (
    (T = Math.max(8, Math.min(T, m.width - w - 8))),
    (b = Math.max(8, Math.min(b, m.height - S - 8))),
    /* @__PURE__ */ t("div", {
      role: "dialog",
...
function Ee({ panel: e }) {
  const {
    ...
    T = ie(),
    b = fe(null),
    s = e.tabs.find((n) => n.id === e.activeTabId),
    k = s == null ? void 0 : s.panelModel,
    A = k ? T.resolve(k.content) : null,
    x = c !== null,
    h = (l == null ? void 0 : l.targetPanelId) === e.id,
    { colorScheme: f } = O(),
    d = f === "dark",
    [a, r] = I("center"),
    [v, y] = I(null);
  R(() => {
    h && l?.suggestedPosition && r(l.suggestedPosition);
  }, [h, l == null ? void 0 : l.suggestedPosition]),
    R(() => {
      if (!h) return;
      const n = (u) => {
          u.target.closest("[role=dialog]") || S();
        },
        P = setTimeout(() => document.addEventListener("click", n), 100);
      return () => {
  ...
  const E = D(
    ...
    z = D(
      (n) => {
        n.preventDefault(),
          n.stopPropagation(),
          b.current && y(b.current.getBoundingClientRect()),
          r("center"),
          p(e.id, "center", { x: n.clientX, y: n.clientY });
      },
      [e.id, p],
    ),
    M = (n) => {
      ...
      if (n === "center" && h && a === "center") return { ...u, inset: 0 };
      if (a === n) {
                ...
                "div",
                {
                  ...
                  onDragStart: (u) => {
                    (u.dataTransfer.effectAllowed = "move"),
                      u.dataTransfer.setData("text/plain", n.id),
                      g(n.id, e.id);
                  },
                  onDragEnd: () => m(),
                  onClick: () => i(e.id, n.id),
            ...
            /* @__PURE__ */ t("div", {
              ...
              children:
                ...
                /* @__PURE__ */ t("div", {
                  ...
                  children: /* @__PURE__ */ t(A, { model: k.content }),
                }),
            }),
...
function Q({ node: e }) {
  return xe(e)
    ? /* @__PURE__ */ t(Ee, { panel: e })
    : De(e)
      ? /* @__PURE__ */ t(ze, { split: e })
      : null;
}
function Re() {
  const { root: e } = U();
...
const [Me] = re("aspect:component-registry", () => new le()),
...
function _e({ context: e, wrapper: o }) {
  ...
  R(() => {
    function a(r) {
      ...
      if (
        ...
        return;
      const y = [];
      (r.ctrlKey || r.metaKey) && y.push("Ctrl"),
        r.shiftKey && y.push("Shift"),
        r.altKey && y.push("Alt"),
        y.push(r.key);
      const E = y.length > 1 ? y.join("+") : r.key,
        z = h.getBindings(E).length > 0 ? h.getBindings(E) : h.getBindings(r.key);
      for (const n of z) n.preventDefault !== !1 && r.preventDefault(), n.execute();
    }
    return (
      document.addEventListener("keydown", a), () => document.removeEventListener("keydown", a)
    );
  }, [h]);
  const f = w.length > 0 ? w[w.length - 1] : void 0,
    d = /* @__PURE__ */ t(ae.Provider, {
      value: i,
  ...
  return /* @__PURE__ */ t($.Provider, {
    value: { colorScheme: k, toggle: x },
    children: o ? /* @__PURE__ */ t(o, { children: d }) : d,
  });
}
function Ke({ menus: e }) {
  ...
  return /* @__PURE__ */ C(j, {
    ...
    children: [
        ...
        /* @__PURE__ */ C(
          G,
          {
            children: [
              /* @__PURE__ */ t(V, {
                isQuiet: !0,
                children: /* @__PURE__ */ t(N, { children: c.label ?? c.actionKey }),
              }),
              /* @__PURE__ */ t(J, {
                onAction: (g) => {
                ...
                children: c.children.map((g) =>
                  /* @__PURE__ */ t(Z, { children: g.label ?? g.actionKey }, g.actionKey),
                ),
              }),
            ],
          },
      ...
      /* @__PURE__ */ t(V, {
        ...
        children: /* @__PURE__ */ t(N, { children: o === "dark" ? "☀" : "🌙" }),
      }),
    ],
  });
}
...
function Le({ dialog: e, registry: o }) {
  if (!e) return null;
  const i = o.resolve(e);
  return i
    ? /* @__PURE__ */ t(ee, {
