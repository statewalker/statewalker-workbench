...
import type { UrlSerializer } from "../../src/index.js";
import { UrlStateView } from "../../src/index.js";

describe("UrlStateView", () => {
  it("registers and disposes serializers [AC: serializers build and dispose]", () => {
  ...
  it("runs serializers in registration order [AC: serializers run in registration order]", () => {
    const view = new UrlStateView();
    view.register({
  ...
  describe("loop prevention [AC: sync and applyUrl are loop-protected]", () => {
