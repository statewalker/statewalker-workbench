...
```sh
pnpm add @statewalker/shared-react
```

## Usage

```ts
import { useView } from "@statewalker/shared-react";
...
- `@statewalker/shared-views` — views this package renders.
- `@statewalker/shared-react-shadcn` / `@statewalker/shared-react-spectrum` — concrete design-system implementations.
